...
Se sont déclarés par les différentes initiatives les contributeurs suivants :
...
* Passam KACEM : Hadoop 2017, puis DataStax 2018
* Rithy NGUON : Hadoop 2017, puis DataStax 2018
* Patrick YOUMBI : DataStax 2017, puis Hadoop 2018
* Jérémie LOU : Hadoop 2017, puis Cassandra 2018. *Les 2 à confirmer*
