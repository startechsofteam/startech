...
* Faycal nous a parlé de *svelte*, un nouveau framework front en Javascript (n'existe que depuis quelques jours, mais fait déjà le buzz sur GitHub avec plus de 3000 stars). +
Il s'agit d'un transpilateur, le fichier généré pouvant être utilisé tel quel, sans ajout. +
